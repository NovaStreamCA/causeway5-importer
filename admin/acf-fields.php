    ...
    if( function_exists('acf_add_local_field_group') ) {
        ...
        acf_add_local_field_group([
            ...
            'fields' => [
                ...
                ['key' => 'field_is_campaign_only', 'label' => 'Is Campaign Only?', 'name' => 'is_campaign_only', 'type' => 'true_false'],
        ...
        acf_add_local_field_group([
            ...
            'fields' => [
                ...
                [
                    'key' => 'field_import_filter_areas',
                    'label' => 'Limit to Areas (optional)',
                    'name' => 'import_filter_areas',
                    'type' => 'taxonomy',
                    'taxonomy' => 'listing-areas',
                    'field_type' => 'multi_select',
                    'return_format' => 'id',
                    ...
                    'multiple' => 1,
                    'allow_null' => 1,
                    'instructions' => 'If set, only listings within these Areas will be imported. Leave empty to import all.',
                ],
                [
                    'key' => 'field_import_filter_communities',
                    'label' => 'Limit to Communities (optional)',
                    'name' => 'import_filter_communities',
                    'type' => 'taxonomy',
                    'taxonomy' => 'listing-communities',
                    'field_type' => 'multi_select',
                    'return_format' => 'id',
                    ...
                    'multiple' => 1,
                    'allow_null' => 1,
                    'instructions' => 'If set, only listings within these Communities will be imported. Leave empty to import all.',
                ],
                [
                ...
                [
                    'key' => 'field_causeway_enable_importer',
                    'label' => 'Enable Importer',
                    'name' => 'causeway_enable_importer',
                    'type' => 'true_false',
                    'ui' => 1,
                    'message' => 'When disabled, new Causeway imports are blocked (manual, cron, and CLI).',
                    'default_value' => 1,
                ],
                [
                    'key' => 'field_causeway_enable_exporter',
                    'label' => 'Enable Exporter',
                    'name' => 'causeway_enable_exporter',
                    'type' => 'true_false',
                    'ui' => 1,
                    'message' => 'When disabled, new Causeway exports are blocked (manual and cron).',
                    'default_value' => 1,
                ],
                [
