...
function causeway_enqueue_mixitup_scripts(): void {
    ...
    wp_register_script('causeway-mixitup-init', $base . 'causeway.mixitup.js', ['mixitup','mixitup-multifilter','mixitup-pagination'], '1.0.1', true);
